 ...
 * @param num       - The number of the window to clear the text from.
 * @param can_vote  - Boolean (true/false).  If true, than we can deep-six this
 * user. If false, then we cannot.
 */
void can_deepsix_user(int num, int can_vote);

/* Sets the status of this user (which appears as a single wchar_tacter after
 * there username).
 * @param num     - The number of the window to clear the text from.
